...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" 	ChildrenAsTriggers="False" UpdateMode="Conditional">
     <ContentTemplate>
        ...
        style="z-index: 1; left: 360px; top: 152px; position: absolute"></asp:Label>
     </ContentTemplate>
     <Triggers>
   ...
   <asp:TextBox ID="txtCurrentPassword" runat="server" 
    ...
    <asp:TextBox ID="txtNewPassword" runat="server" 
        style="z-index: 1; left: 184px; top: 149px; position: absolute; height: 18px;" 
    ...
    <asp:Label ID="lblError" runat="server" ForeColor="Red" 
        style="z-index: 1; left: 215px; top: 281px; position: absolute"></asp:Label>
